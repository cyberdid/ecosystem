...
| [M6 functional-orchestration threat model](../architecture/m6-functional-orchestration-threat-model.md) | Exact M1–M5 baseline, runtime/adapter/store audit and adversarial multi-agent analysis | M6.1 is blocked from claiming completion until typed channels, durable model operations, source integrity, budgets, recovery, redaction and independent hard gates pass |
