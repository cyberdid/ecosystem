<!-- eco:managed:start client="claude" source=".ai/instructions.yaml" digest="f5ace45850162c507df65d774d4e8db864083ea4ebdf7d7d855cbb364343215f" -->
# ecosystem — AI instructions

> Projection for Claude Code. Generated from `.ai/instructions.yaml`; authorization is enforced outside prompts.
